...
proc create_root_design { parentCell } {
  ...
  set WP1_ADC_Control_0 [ create_bd_cell -type ip -vlnv elettronica.le.infn.it:user:WP1_ADC_Control:1.0 WP1_ADC_Control_0 ]
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1}  ] $axi_gpio_0

  # Create instance: axi_mem_intercon, and set properties
  set axi_mem_intercon [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon ]
  set_property -dict [ list CONFIG.NUM_MI {9}  ] $axi_mem_intercon
...
CONFIG.PCW_TTC0_PERIPHERAL_ENABLE {1} CONFIG.PCW_UART0_GRP_FULL_ENABLE {1} \
CONFIG.PCW_UART0_UART0_IO {MIO 46 .. 47} CONFIG.PCW_UART1_GRP_FULL_ENABLE {0} \
CONFIG.PCW_USB0_RESET_ENABLE {1} CONFIG.PCW_USB0_RESET_IO {MIO 51} \
CONFIG.PCW_USE_EXPANDED_IOP {1}  ] $processing_system7_0
  ...
  connect_bd_net -net In_regional_ck_0_IBUF_OUT [get_bd_pins In_regional_ck_0/IBUF_OUT] [get_bd_pins Interface_uub_0/FPGA_CK] [get_bd_pins WP1_ADC_Control_0/FPGA_CK] [get_bd_pins selectio_wiz_0/clk_in] [get_bd_pins selectio_wiz_1/clk_in] [get_bd_pins selectio_wiz_2/clk_in] [get_bd_pins selectio_wiz_3/clk_in] [get_bd_pins selectio_wiz_4/clk_in]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins WP1_ADC_Control_0/INT_TRIG] [get_bd_pins axi_gpio_0/gpio_io_o]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Interface_uub_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_3/s_axi_aclk] [get_bd_pins axi_bram_ctrl_4/s_axi_aclk] [get_bd_pins axi_bram_ctrl_5/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/M02_ACLK] [get_bd_pins axi_mem_intercon/M03_ACLK] [get_bd_pins axi_mem_intercon/M04_ACLK] [get_bd_pins axi_mem_intercon/M05_ACLK] [get_bd_pins axi_mem_intercon/M06_ACLK] [get_bd_pins axi_mem_intercon/M07_ACLK] [get_bd_pins axi_mem_intercon/M08_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_processing_system7_0_97M/slowest_sync_clk]
