...
# Hierarchical cell: Wp1_ADC_data
proc create_hier_cell_Wp1_ADC_data { parentCell nameHier } {

  if { $parentCell eq "" || $nameHier eq "" } {
     puts "ERROR: create_hier_cell_Wp1_ADC_data() - Empty argument(s)!"
     return
  }
  ...
  create_bd_pin -dir I -from 7 -to 0 Config_Trig
  create_bd_pin -dir I EXT_TRIG
  create_bd_pin -dir I FPGA_CK
  create_bd_pin -dir O -from 15 -to 0 Stop_Addr
...
=======
  ...
  # Create instance: axi_mem_intercon, and set properties
  set axi_mem_intercon [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon ]
  set_property -dict [ list CONFIG.NUM_MI {11}  ] $axi_mem_intercon
...
<<<<<<< HEAD
  ...
  connect_bd_net -net WP1_ADC_Control_0_Stop_Addr [get_bd_pins Stop_Addr] [get_bd_pins WP1_ADC_Control_0/Stop_Addr]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Config_Trig] [get_bd_pins WP1_ADC_Control_0/Config_Trig]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_3/s_axi_aclk] [get_bd_pins axi_bram_ctrl_4/s_axi_aclk] [get_bd_pins axi_bram_ctrl_5/s_axi_aclk]
  connect_bd_net -net rst_processing_system7_0_97M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins WP1_ADC_Control_0/RSTn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_3/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_4/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_5/s_axi_aresetn] [get_bd_pins blk_mem_gen_0/rsta] [get_bd_pins blk_mem_gen_1/rsta] [get_bd_pins blk_mem_gen_2/rsta] [get_bd_pins blk_mem_gen_3/rsta] [get_bd_pins blk_mem_gen_4/rsta]
...
CONFIG.PCW_TTC0_PERIPHERAL_ENABLE {1} CONFIG.PCW_UART0_GRP_FULL_ENABLE {0} \
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Wp1_ADC_data
  create_hier_cell_Wp1_ADC_data [current_bd_instance .] Wp1_ADC_data
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M03_AXI [get_bd_intf_pins Wp1_ADC_data/S_AXI] [get_bd_intf_pins ZYNC_block/M03_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M04_AXI [get_bd_intf_pins Wp1_ADC_data/S_AXI1] [get_bd_intf_pins ZYNC_block/M04_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M05_AXI [get_bd_intf_pins Wp1_ADC_data/S_AXI2] [get_bd_intf_pins ZYNC_block/M05_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M06_AXI [get_bd_intf_pins Wp1_ADC_data/S_AXI3] [get_bd_intf_pins ZYNC_block/M06_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M07_AXI [get_bd_intf_pins Wp1_ADC_data/S_AXI4] [get_bd_intf_pins ZYNC_block/M07_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M08_AXI [get_bd_intf_pins ZYNC_block/M08_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M09_AXI [get_bd_intf_pins ZYNC_block/M09_AXI] [get_bd_intf_pins axi_gpio_1/S_AXI]
  ...
  connect_bd_net -net In_regional_ck_0_IBUF_OUT [get_bd_pins Interface_uub_0/FPGA_CK] [get_bd_pins WP1_LED_Control_0/clock] [get_bd_pins WP5_data_blok/IBUF_OUT1] [get_bd_pins Wp1_ADC_data/FPGA_CK] [get_bd_pins Wp2_Trigger_block/clkb] [get_bd_pins clock_1pps_0/CLK120]
=======
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M02_AXI [get_bd_intf_pins axi_mem_intercon/M02_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M03_AXI [get_bd_intf_pins axi_bram_ctrl_1/S_AXI] [get_bd_intf_pins axi_mem_intercon/M03_AXI]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M05_AXI [get_bd_intf_pins axi_bram_ctrl_3/S_AXI] [get_bd_intf_pins axi_mem_intercon/M05_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M06_AXI [get_bd_intf_pins axi_bram_ctrl_4/S_AXI] [get_bd_intf_pins axi_mem_intercon/M06_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M07_AXI [get_bd_intf_pins axi_bram_ctrl_5/S_AXI] [get_bd_intf_pins axi_mem_intercon/M07_AXI]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M09_AXI [get_bd_intf_pins axi_gpio_1/S_AXI] [get_bd_intf_pins axi_mem_intercon/M09_AXI]
  ...
  connect_bd_net -net GPS_PPS_1 [get_bd_ports GPS_PPS] [get_bd_pins Interface_uub_0/GPS_PPS] [get_bd_pins WP1_LED_Control_0/PPS]
  connect_bd_net -net In_regional_ck_0_IBUF_OUT [get_bd_pins In_regional_ck_0/IBUF_OUT] [get_bd_pins Interface_uub_0/FPGA_CK] [get_bd_pins WP1_ADC_Control_0/FPGA_CK] [get_bd_pins WP1_LED_Control_0/clock] [get_bd_pins selectio_wiz_0/clk_in] [get_bd_pins selectio_wiz_1/clk_in] [get_bd_pins selectio_wiz_2/clk_in] [get_bd_pins selectio_wiz_3/clk_in] [get_bd_pins selectio_wiz_4/clk_in]
>>>>>>> 2beaa5130f425292206b0f1e5bde86633226516b
...
<<<<<<< HEAD
  connect_bd_net -net TRIG_IN_1 [get_bd_ports TRIG_IN] [get_bd_pins Interface_uub_0/TRIG_IN] [get_bd_pins Wp1_ADC_data/EXT_TRIG]
  ...
  connect_bd_net -net WP1_ADC_Control_0_ADC_data [get_bd_pins Wp1_ADC_data/ADC_data] [get_bd_pins Wp2_Trigger_block/ADC]
  connect_bd_net -net WP1_ADC_Control_0_ASY_TRIG [get_bd_pins WP1_LED_Control_0/ASY_TRIG] [get_bd_pins Wp1_ADC_data/ASY_TRIG]
  connect_bd_net -net WP1_ADC_Control_0_Stop_Addr [get_bd_pins Wp1_ADC_data/Stop_Addr] [get_bd_pins axi_gpio_1/gpio_io_i]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Wp1_ADC_data/Config_Trig] [get_bd_pins axi_gpio_0/gpio_io_o]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Interface_uub_0/s00_axi_aclk] [get_bd_pins WP5_data_blok/s_axi_aclk] [get_bd_pins Wp1_ADC_data/s_axi_aclk] [get_bd_pins Wp2_Trigger_block/s00_axi_aclk] [get_bd_pins ZYNC_block/FCLK_CLK0] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins WP5_data_blok/REF_CLOCK] [get_bd_pins ZYNC_block/FCLK_CLK1]
  connect_bd_net -net rst_processing_system7_0_97M_peripheral_aresetn [get_bd_pins Interface_uub_0/s00_axi_aresetn] [get_bd_pins WP1_LED_Control_0/reset] [get_bd_pins WP5_data_blok/s_axi_aresetn] [get_bd_pins Wp1_ADC_data/s_axi_aresetn] [get_bd_pins Wp2_Trigger_block/s00_axi_aresetn] [get_bd_pins ZYNC_block/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn]
  ...
  connect_bd_net -net sde_trigger_0_TRIG_OUT [get_bd_ports TRIG_OUT] [get_bd_pins Wp2_Trigger_block/TRIG_OUT]
  connect_bd_net -net selectio_wiz_0_data_in_to_device [get_bd_pins Interface_uub_0/adc0] [get_bd_pins WP5_data_blok/data_in_to_device] [get_bd_pins Wp1_ADC_data/adc0]
  connect_bd_net -net selectio_wiz_1_data_in_to_device [get_bd_pins Interface_uub_0/adc1] [get_bd_pins WP5_data_blok/data_in_to_device1] [get_bd_pins Wp1_ADC_data/adc1]
  connect_bd_net -net selectio_wiz_2_data_in_to_device [get_bd_pins Interface_uub_0/adc2] [get_bd_pins WP5_data_blok/data_in_to_device2] [get_bd_pins Wp1_ADC_data/adc2]
  connect_bd_net -net selectio_wiz_3_data_in_to_device [get_bd_pins Interface_uub_0/adc3] [get_bd_pins WP5_data_blok/data_in_to_device3] [get_bd_pins Wp1_ADC_data/adc3]
  connect_bd_net -net selectio_wiz_4_data_in_to_device [get_bd_pins Interface_uub_0/adc4] [get_bd_pins WP5_data_blok/data_in_to_device4] [get_bd_pins Wp1_ADC_data/adc4]
  ...
  create_bd_addr_seg -range 0x4000 -offset 0x42000000 [get_bd_addr_spaces ZYNC_block/processing_system7_0/Data] [get_bd_addr_segs Wp1_ADC_data/axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x4000 -offset 0x44000000 [get_bd_addr_spaces ZYNC_block/processing_system7_0/Data] [get_bd_addr_segs Wp1_ADC_data/axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x4000 -offset 0x46000000 [get_bd_addr_spaces ZYNC_block/processing_system7_0/Data] [get_bd_addr_segs Wp1_ADC_data/axi_bram_ctrl_3/S_AXI/Mem0] SEG_axi_bram_ctrl_3_Mem0
  create_bd_addr_seg -range 0x4000 -offset 0x48000000 [get_bd_addr_spaces ZYNC_block/processing_system7_0/Data] [get_bd_addr_segs Wp1_ADC_data/axi_bram_ctrl_4/S_AXI/Mem0] SEG_axi_bram_ctrl_4_Mem0
  create_bd_addr_seg -range 0x4000 -offset 0x4A000000 [get_bd_addr_spaces ZYNC_block/processing_system7_0/Data] [get_bd_addr_segs Wp1_ADC_data/axi_bram_ctrl_5/S_AXI/Mem0] SEG_axi_bram_ctrl_5_Mem0
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x41210000 [get_bd_addr_spaces ZYNC_block/processing_system7_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
...
=======
  connect_bd_net -net TRIG_IN_1 [get_bd_ports TRIG_IN] [get_bd_pins WP1_ADC_Control_0/EXT_TRIG] [get_bd_pins util_vector_logic_1/Op2]
  connect_bd_net -net USB_IFAULT_1 [get_bd_ports USB_IFAULT] [get_bd_pins Interface_uub_0/USB_IFAULT]
  connect_bd_net -net WATCHDOG_1 [get_bd_ports WATCHDOG] [get_bd_pins Interface_uub_0/WATCHDOG]
  connect_bd_net -net WP1_ADC_Control_0_ADC0_mem [get_bd_pins WP1_ADC_Control_0/ADC0_mem] [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net WP1_ADC_Control_0_ADC1_mem [get_bd_pins WP1_ADC_Control_0/ADC1_mem] [get_bd_pins blk_mem_gen_1/dina]
  ...
  connect_bd_net -net WP1_ADC_Control_0_ADC3_mem [get_bd_pins WP1_ADC_Control_0/ADC3_mem] [get_bd_pins blk_mem_gen_3/dina]
  connect_bd_net -net WP1_ADC_Control_0_ADC4_mem [get_bd_pins WP1_ADC_Control_0/ADC4_mem] [get_bd_pins blk_mem_gen_4/dina]
  connect_bd_net -net WP1_ADC_Control_0_ASY_TRIG [get_bd_pins WP1_ADC_Control_0/ASY_TRIG] [get_bd_pins WP1_LED_Control_0/ASY_TRIG]
  connect_bd_net -net WP1_ADC_Control_0_BRAM_CK [get_bd_pins WP1_ADC_Control_0/BRAM_CK] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_1/clka] [get_bd_pins blk_mem_gen_2/clka] [get_bd_pins blk_mem_gen_3/clka] [get_bd_pins blk_mem_gen_4/clka]
  connect_bd_net -net WP1_ADC_Control_0_Stop_Addr [get_bd_pins WP1_ADC_Control_0/Stop_Addr] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net WP1_LED_Control_0_LED_OUT [get_bd_ports LED_ASY] [get_bd_pins Interface_uub_0/LED_FLG] [get_bd_pins WP1_LED_Control_0/LED_OUT] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_97M/aux_reset_in] [get_bd_pins rst_processing_system7_0_97M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_97M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins rst_processing_system7_0_97M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_97M_peripheral_aresetn [get_bd_pins Interface_uub_0/s00_axi_aresetn] [get_bd_pins WP1_ADC_Control_0/RSTn] [get_bd_pins WP1_LED_Control_0/reset] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_3/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_4/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_5/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/M02_ARESETN] [get_bd_pins axi_mem_intercon/M03_ARESETN] [get_bd_pins axi_mem_intercon/M04_ARESETN] [get_bd_pins axi_mem_intercon/M05_ARESETN] [get_bd_pins axi_mem_intercon/M06_ARESETN] [get_bd_pins axi_mem_intercon/M07_ARESETN] [get_bd_pins axi_mem_intercon/M08_ARESETN] [get_bd_pins axi_mem_intercon/M09_ARESETN] [get_bd_pins axi_mem_intercon/M10_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins blk_mem_gen_0/rsta] [get_bd_pins blk_mem_gen_1/rsta] [get_bd_pins blk_mem_gen_2/rsta] [get_bd_pins blk_mem_gen_3/rsta] [get_bd_pins blk_mem_gen_4/rsta] [get_bd_pins rst_processing_system7_0_97M/peripheral_aresetn]
  ...
  connect_bd_net -net selectio_wiz_0_data_in_to_device [get_bd_pins Interface_uub_0/adc0] [get_bd_pins WP1_ADC_Control_0/adc0] [get_bd_pins selectio_wiz_0/data_in_to_device]
  connect_bd_net -net selectio_wiz_1_data_in_to_device [get_bd_pins Interface_uub_0/adc1] [get_bd_pins WP1_ADC_Control_0/adc1] [get_bd_pins selectio_wiz_1/data_in_to_device]
  connect_bd_net -net selectio_wiz_2_data_in_to_device [get_bd_pins Interface_uub_0/adc2] [get_bd_pins WP1_ADC_Control_0/adc2] [get_bd_pins selectio_wiz_2/data_in_to_device]
  connect_bd_net -net selectio_wiz_3_data_in_to_device [get_bd_pins Interface_uub_0/adc3] [get_bd_pins WP1_ADC_Control_0/adc3] [get_bd_pins selectio_wiz_3/data_in_to_device]
  connect_bd_net -net selectio_wiz_4_data_in_to_device [get_bd_pins Interface_uub_0/adc4] [get_bd_pins WP1_ADC_Control_0/adc4] [get_bd_pins selectio_wiz_4/data_in_to_device]
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports TRIG_OUT] [get_bd_pins util_vector_logic_1/Res]
  ...
  create_bd_addr_seg -range 0x4000 -offset 0x42000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x4000 -offset 0x44000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x4000 -offset 0x46000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_3/S_AXI/Mem0] SEG_axi_bram_ctrl_3_Mem0
  create_bd_addr_seg -range 0x4000 -offset 0x48000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_4/S_AXI/Mem0] SEG_axi_bram_ctrl_4_Mem0
  create_bd_addr_seg -range 0x4000 -offset 0x4A000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_5/S_AXI/Mem0] SEG_axi_bram_ctrl_5_Mem0
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
